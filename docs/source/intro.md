...
**Medunda**:  Marine Engine for Downloading, Understanding and Navigating Data and Analysis for Mediterranean and Global Oceanography
...
1. The Downloader **{ref}`downloaderdoc`**
2. The Reducer **{ref}`reducerdoc`**
3. The Plotter **{ref}`plotterdoc`**

This workflow provides a coherent framework for transforming large and complex oceanographic datasets into analysis-ready products.
