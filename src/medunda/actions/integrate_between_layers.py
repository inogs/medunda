...
def integrate_between_layers (data: xr.Dataset, depth_min, depth_max) -> xr.Dataset:
    ...
    for variable in data.data_vars:
        ...
        weighted_average = (selected_layer*layer_height_extended).sum(dim="depth", skipna=True)
