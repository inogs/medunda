"""
The plotter is a visualization tool for plotting data generated by
the downloader or the reducer in NetCDF, CSV, or GeoTIFF format.

It supports plotting timeseries and spatial maps.

It provides a command line interface for users to specify the input file, the variable to plot,
and the desired output directory for saving the generated plots.
"""
